          ...
          <form @submit.prevent="submitReply">
            <div class="flex gap-3">
              <textarea
                ...
                placeholder="پاسخ خود را بنویسید (Enter: سطر جدید، Ctrl + Enter: ارسال)..."
              ></textarea>
              ...
              >
                ...
                <span>{{ form.processing ? 'ارسال...' : 'ارسال' }}</span>
              </button>
            </div>

            <div class="flex items-center justify-between mt-2 text-[11px] text-slate-400">
              <span>راهنما: کلید Enter برای سطر جدید و ترکیب Ctrl + Enter برای ارسال سریع پاسخ است.</span>
              <span v-if="form.errors.message" class="text-xs text-red-500 font-medium">{{ form.errors.message }}</span>
            </div>
          </form>
        </div>
